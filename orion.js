...
// ============================================================
// Versão com correção de SQLITE_ERROR e logs detalhados
// ============================================================
...
// Criação da tabela estacoes com tratamento de erros
db.serialize(() => {
  ...
  // Criação da tabela importacao_log
  db.run(`CREATE TABLE IF NOT EXISTS importacao_log (
    ...
    if (err) {
      console.error('❌ Erro ao criar tabela importacao_log:', err.message);
    }
  });
});
